...
if sys.base_prefix == sys.prefix:
    raise RuntimeError("Virtual environment is not activated. Please activate .venv before running.")
    ...
    def sendTextResponseToClient(self, transcription, sentences, done):
        ...
        for message in messages:
            if self.running == True:
                ...
                #if sentences is not empty then it has the full sentence
                if message["sentence"] != "":
